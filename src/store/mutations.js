...
const mutations = {
  ...
  //// ADD BY GUPY WANTORO
  ////////
  retrieveCustomerServiceList (state, data) {
    state.customerServiceList = data
  },
  retrieveServiceList (state, data) {
    state.serviceList = data
  },
  retrieveVendorDetail (state, data) {
    state.vendorList = data
  },
  retrieveVendorList (state, data) {
    state.vendorList = data
  },
  retrieveCustomerDetail (state, data) {
    state.customerList = data
  },
  retrieveCustomerList (state, data) {
    state.customerList = data
  },
  retrieveUserDetail (state, data) {
    state.userList = data
  },
  retrieveUserList (state, data) {
    state.userList = data
  },
  destroyToken (state) {
    state.token = null
